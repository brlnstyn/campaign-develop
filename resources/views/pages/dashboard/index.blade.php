                                ...
                                <div class="card-body d-flex flex-column flex-center">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <h1 class="fw-semibold text-gray-800 text-center lh-lg">Have you tried
                                            <br />new
                                            <span class="fw-bolder">Campaign App ?</span>
                                        </h1>
                                        <!--end::Title-->
                                        <!--begin::Illustration-->
                                        <div class="py-5 text-center">
                                            <img src="{{ asset('asset/media/svg/illustrations/easy/2.svg') }}"
                                                class="theme-light-show w-200px" alt="" />
                                            <img src="{{ asset('asset/media/svg/illustrations/easy/2-dark.svg') }}"
                                    ...
                                    <div class="text-center mb-1">
                                        ...
                                        <a class="btn btn-sm btn-primary me-2"
                                            href="{{ route('campaign.create.step.one') }}">New Campaign</a>
                                        <!--end::Link-->
                                    </div>
                                    <!--end::Links-->
                                </div>
                            ...
                            <div class="card card-flush xl-100">
                                ...
                                <div class="card-header pt-7">
                                    ...
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label fw-bold text-gray-800">Recent Campaign</span>
                                    </h3>
                                    <!--end::Title-->
                                    <!--begin::Actions-->
                                </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @switch($item)
                                                            ...
                                                            @default
                                                                <span class="badge py-3 px-4 fs-7 badge-light-info">On Going</span>
                                                        @endswitch
