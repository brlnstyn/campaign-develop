            ...
            <div class="card">
                ...
                <div class="card-header card-header-stretch">
                    ...
                    <div class="card-title d-flex align-items-center">
                        ...
                        <!--end::Svg Icon-->
                        <h3 class="fw-bold m-0 text-gray-800">History Campaign</h3>
                    </div>
                    <!--end::Title-->
                    <!--begin::Toolbar-->
                            ...
                            <div class="timeline">
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-content mb-10 mt-n1">
                                        ...
                                        <div class="pe-3 mb-5">
                                            <!--begin::Title-->
                                            <div class="fs-5 fw-semibold mb-2">Join Survei Kepuasan Pelanggan</div>
                                            <!--end::Title-->
                                            <!--begin::Description-->
                                        ...
                                        <div class="overflow-auto pb-5">
                                            ...
                                            <div
                                                ...
                                                <a href="../../demo1/dist/apps/projects/project.html"
                                                    class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Participate
                                                    in Campaign</a>
                                                <!--end::Title-->
                                                <!--begin::Label-->
                                                <div class="min-w-175px pe-2">
                                                    <span class="badge badge-light text-muted">Survei Kepuasan
                                                        Pelanggan</span>
                                                </div>
                                                <!--end::Label-->
                                                <!--begin::Users-->
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-content mb-10 mt-n2">
                                        ...
                                        <div class="overflow-auto pe-3">
                                            <!--begin::Title-->
                                            <div class="fs-5 fw-semibold mb-2">Created Survei Perencanaan Acara</div>
                                            <!--end::Title-->
                                            <!--begin::Description-->
                                            <div class="d-flex align-items-center mt-1 fs-6">
                                                <!--begin::Info-->
                                            ...
                                            <div
                                                ...
                                                <!--begin::Title-->
                                                <a href="../../demo1/dist/apps/projects/project.html"
                                                    class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Created
                                                    a Campaign</a>
                                                <!--end::Title-->
                                                <!--begin::Label-->
                                                <div class="min-w-175px pe-2">
                                                    <span class="badge badge-light text-muted">Survei Perencanaan
                                                        Acara</span>
                                                </div>
                                                <!--end::Label-->
                                                <!--begin::Users-->
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-content mb-10 mt-n1">
                                        ...
                                        <div class="mb-5 pe-3">
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="fs-5 fw-semibold text-gray-800 text-hover-primary mb-2">Join Survei
                                            ...
                                            <div
                                                ...
                                                <!--begin::Title-->
                                                <a href="../../demo1/dist/apps/projects/project.html"
                                                    class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Perticipate
                                                    in Campaign</a>
                                                <!--end::Title-->
                                                <!--begin::Label-->
                                                <div class="min-w-175px pe-2">
