                                    ...
                                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="d-flex align-items-center mb-2">
                                                <a href="#"
                                                    class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">{{ $value->respondent_name }}</a>
                                                <a href="#">
                                            ...
                                            <div class="d-flex flex-wrap">
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <span class="svg-icon svg-icon-1 svg-icon-success me-2">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="30"
                                                                height="30" fill="currentColor" class="bi bi-hash"
                                                                viewBox="0 0 16 16">
                                                                <path
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <!--end::Svg Icon-->
                                                        <div class="fs-2 fw-bold">{{ $value->entry_date }}</div>
                                                    </div>
                                                    <!--end::Number-->
                                                    <!--begin::Label-->
