            ...
            <div class="card-header flex-nowrap border-0 pt-9">
                ...
                <div class="card-title m-0">
                    ...
                    <div class="symbol symbol-45px w-45px bg-light me-5">
                        <img src="asset/media/svg/brand-logos/twitch.svg" alt="image" class="p-3" />
                    </div>
                    <!--end::Icon-->
                    <!--begin::Title-->
        ...
        <div class="card h-100">
            ...
            <div class="card-header flex-nowrap border-0 pt-9">
                ...
                <div class="card-title m-0">
                    <!--begin::Icon-->
                    <div class="symbol symbol-45px w-45px bg-light me-5">
                        <img src="asset/media/svg/brand-logos/twitter.svg" alt="image" class="p-3" />
                    </div>
                    <!--end::Icon-->
                    <!--begin::Title-->
        ...
        <div class="card h-100">
            ...
            <div class="card-header flex-nowrap border-0 pt-9">
                ...
                <div class="card-title m-0">
                    <!--begin::Icon-->
                    <div class="symbol symbol-45px w-45px bg-light me-5">
                        <img src="asset/media/svg/brand-logos/spotify.svg" alt="image" class="p-3" />
                    </div>
                    <!--end::Icon-->
                    <!--begin::Title-->
        ...
        <div class="card h-100">
            ...
            <div class="card-header flex-nowrap border-0 pt-9">
                ...
                <div class="card-title m-0">
                    <!--begin::Icon-->
                    <div class="symbol symbol-45px w-45px bg-light me-5">
                        <img src="asset/media/svg/brand-logos/pinterest-p.svg" alt="image" class="p-3" />
                    </div>
                    <!--end::Icon-->
                    <!--begin::Title-->
        ...
        <div class="card h-100">
            ...
            <div class="card-header flex-nowrap border-0 pt-9">
                ...
                <div class="card-title m-0">
                    <!--begin::Icon-->
                    <div class="symbol symbol-45px w-45px bg-light me-5">
                        <img src="asset/media/svg/brand-logos/github.svg" alt="image" class="p-3" />
                    </div>
                    <!--end::Icon-->
                    <!--begin::Title-->
        ...
        <div class="card h-100">
            ...
            <div class="card-header flex-nowrap border-0 pt-9">
                ...
                <div class="card-title m-0">
                    <!--begin::Icon-->
                    <div class="symbol symbol-45px w-45px bg-light me-5">
                        <img src="asset/media/svg/brand-logos/youtube-play.svg" alt="image" class="p-3" />
                    </div>
                    <!--end::Icon-->
                    <!--begin::Title-->
        ...
        <div class="card h-100">
            ...
            <div class="card-header flex-nowrap border-0 pt-9">
                ...
                <div class="card-title m-0">
                    <!--begin::Icon-->
                    <div class="symbol symbol-45px w-45px bg-light me-5">
                        <img src="asset/media/svg/brand-logos/telegram.svg" alt="image" class="p-3" />
                    </div>
                    <!--end::Icon-->
                    <!--begin::Title-->
        ...
        <div class="card h-100">
            ...
            <div class="card-header flex-nowrap border-0 pt-9">
                ...
                <div class="card-title m-0">
                    <!--begin::Icon-->
                    <div class="symbol symbol-45px w-45px bg-light me-5">
                        <img src="asset/media/svg/brand-logos/reddit.svg" alt="image" class="p-3" />
                    </div>
                    <!--end::Icon-->
                    <!--begin::Title-->
                        ...
                        <div data-kt-stepper-element="content">
                            ...
                            <div class="w-100">
                                ...
                                <div class="text-center px-4">
                                    <img src="asset/media/illustrations/sketchy-1/20.png" alt="" class="mw-100 mh-300px" />
                                </div>
                                <!--end::Illustration-->
                            </div>
                        </div>
